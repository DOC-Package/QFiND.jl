...
save_expon_coeff(efr.expon ./ icm2ifs, efr.coeff ./ icm2ifs^2.0, "expon_coeff_s0t1_real.txt")  
save_expon_coeff(efi.expon ./ icm2ifs, efi.coeff ./ icm2ifs^2.0, "expon_coeff_s0t1_imag.txt")

approx = efr.(t) + im * efi.(t)
evaluate_error(t, approx, c)
plot_bcf(t, approx, c,  "./figure/bcf_s0t1_real.png")
