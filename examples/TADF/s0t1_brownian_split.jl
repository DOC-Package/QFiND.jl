...
save_expon_coeff(freq_real ./ icm2ifs, coeff_real ./ icm2ifs^2.0, "expon_coeff_s0t1_real.txt")  
save_expon_coeff(freq_imag ./ icm2ifs, coeff_imag ./ icm2ifs^2.0, "expon_coeff_s0t1_imag.txt")
...
plot_bcf(t, bcf_approx.(t), c,  "./figure/bcf_s0t1.png")
